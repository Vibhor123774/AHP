  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Navigation Bar */}
        <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none px-3 py-2 lg:px-8 lg:py-4">
          <div className="flex items-center justify-between text-blue-gray-900">
            <div className="flex items-center space-x-2 lg:space-x-4">
              <div className="bg-blue-600 text-white px-2 py-1 lg:px-4 lg:py-2 rounded-lg">
                <Typography variant="h6" className="font-bold text-sm lg:text-base">
                  AHP
                </Typography>
              </div>
              <div className="hidden sm:block">
                ...
                <Typography variant="small" color="gray" className="font-normal text-xs lg:text-sm">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              {/* Write Link */}
              <Link href="/write">
                <Button variant="outlined" size="sm" className="flex items-center space-x-1 lg:space-x-2 px-2 lg:px-4">
                  <ArrowLeftIcon className="h-3 w-3 lg:h-4 lg:w-4" />
                  <span className="text-xs lg:text-sm hidden sm:inline">Write Blogs</span>
                  <span className="text-xs lg:text-sm sm:hidden">Write</span>
                </Button>
              </Link>
              ...
              <Menu>
                <MenuHandler>
                  <Button variant="text" className="flex items-center space-x-1 lg:space-x-2 p-1 lg:p-2">
                    <UserCircleIcon className="h-5 w-5 lg:h-6 lg:w-6" />
                    <span className="hidden md:block text-xs lg:text-sm">{user.role.toUpperCase()}</span>
                  </Button>
                </MenuHandler>
                <MenuList>
        ...
        <div className="container mx-auto px-3 py-4 lg:px-4 lg:py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6 lg:mb-8 text-center">
              <Typography variant="h3" color="blue-gray" className="mb-2 text-xl lg:text-3xl">
                Assignment Form
              </Typography>
              <Typography variant="lead" color="gray" className="text-sm lg:text-base px-4">
            ...
            <Card className="p-4 lg:p-8">
              <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
                ...
                {success && (
                  <Alert color="green" className="mb-4 text-sm">
                    {success}
                  </Alert>
                )}
                ...
                <div className="space-y-3 lg:space-y-4">
                  <Typography variant="h6" color="blue-gray" className="flex items-center text-base lg:text-lg">
                    <UserCircleIcon className="h-4 w-4 lg:h-5 lg:w-5 mr-2" />
                    Client Information
                  </Typography>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-4">
                      ...
                      {showClientSuggestions && clientSuggestions.length > 0 && (
                        <div className="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-auto">
                          {clientSuggestions.map((client, index) => (
                            ...
                            >
                              <div className="font-medium text-gray-900 text-sm lg:text-base">{client.name}</div>
                              {client.phone && (
                                <div className="text-xs lg:text-sm text-gray-600">{client.phone}</div>
                              )}
                    ...
                    <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
                      <div>
                        <Input
                          name="clientNumber"
                          label="Client Number *"
                ...
                <div className="space-y-3 lg:space-y-4">
                  <Typography variant="h6" color="blue-gray" className="flex items-center text-base lg:text-lg">
                    <CurrencyDollarIcon className="h-4 w-4 lg:h-5 lg:w-5 mr-2" />
                    Payment Information
                  </Typography>
                      ...
                      {showWriterSuggestions && writerSuggestions.length > 0 && (
                        <div className="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-auto">
                          {writerSuggestions.map((writer, index) => (
                            ...
                            >
                              <div className="font-medium text-gray-900 text-sm lg:text-base">{writer.name}</div>
                              <div className="text-xs lg:text-sm text-gray-600">{writer.email}</div>
                            </div>
                          ))}
                        </div>
                      )}
                  ...
                  >
                    {isSubmitting ? (
                      <div className="flex items-center justify-center">
                        ...
                        <span className="text-sm lg:text-base">Submitting...</span>
                      </div>
                    ) : (
                      <>
