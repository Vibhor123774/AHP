      ...
      <div className="container mx-auto w-4/5 ">
        ...
        <div>
          ...
          <Typography variant="paragraph" color="black" className="mx-2 mt-4">
            ...
            the region of Québec, strengthens Graybar's footprint in Canada.
          ...
          <Typography variant="paragraph" color="black" className="mx-2 mt-4">
            ...
            distribution assistance services Graybar Canada’s immediate access
          ...
          <Typography variant="paragraph" color="black" className="mx-2 mt-4">
            Graybar Canada can opt to use Parallels® Distant Database Server
